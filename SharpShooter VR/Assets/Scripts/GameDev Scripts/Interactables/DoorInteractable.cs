...
public class DoorInteractable : SimpleHingeInteractable
{
    ...
    [SerializeField]
    [Tooltip("The pivot transform of the door. This is what will rotate about the y-axis with the hinge")]
    ...
    [SerializeField]
    [Tooltip("The rotation the door will be set to when rotated too far inwards")]
    Vector3 rotationLimits;

    [SerializeField]
    [Tooltip("The rotation the door will be set to when rotated too far outwards")]
    Vector3 endRotation;

    [SerializeField]
    [Tooltip("The collider that will determine whether the door is too far closed inward")]
    Collider closedCollider;

    [SerializeField]
    [Tooltip("The collider that will determine whether the door is too far open outwards")]
